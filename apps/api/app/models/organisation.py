...
class OrgMember(Base):
    ...
    organisation_id: Mapped[_PyUUID] = mapped_column(PG_UUID(as_uuid=True), ForeignKey("organisations.organisations.organisation_id", ondelete="CASCADE"), nullable=False)
